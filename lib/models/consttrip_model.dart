...
class ConsttripModel {
  ...
  ConsttripModel({this.id, this.destination, this.flyDate, this.flyTime, this.numberOfFlightHours, this.price, this.availableSeats, this.hotelId, this.transportationId, this.seasonId, this.sectionId, this.continentsId, this.typeTicketId, this.tripschadualId, this.descripyion, this.totalPrice, this.avg, this.photo1, this.photo2, this.photo3, this.createdAt, this.updatedAt});

  ConsttripModel.fromJson(Map<String, dynamic> json) {
    id = json["id"];
